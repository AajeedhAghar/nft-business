          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Business Information</h5>
                ...
                <div class="col-md-4">
                  <label for="establish_date " class="form-label">When was the business established?</label>
            ...
            <div class="col-md-12">
              <label for="employees_number " class="form-label">How many permanent employees does the business have?</label>
              <input type="number" class="form-control" id="employees_number " name="employees_number"> 
          </div>
            ...
            <div class="col-sm-12">
              <select class="form-select" name="entity_type" aria-label="Default select example">
                ...
                <div class="col-md-12">
                    ...
                    <textarea class="form-control" name="highlights" placeholder="" id="all_products_services" style="height: 100px;"></textarea>
                  </div>
                  <div class="col-md-12">
                    <label for="all_products_services" class="form-label">List all products and services of the business</label>
                    <textarea class="form-control" name="facility_details" placeholder="" id="all_products_services" style="height: 100px;"></textarea>
                  </div>
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="input-group col-md-6">           
                        ...
                        <input type="text" class="form-control" aria-label="Amount (to the nearest dollar)" name="Avg_monthly_sales">
                    ...
                    <div class="col-md-6">
                      ...
                      <div class="input-group col-md-6">           
                          <span class="input-group-text">AED</span>
                          <input type="text" class="form-control" aria-label="Amount (to the nearest dollar)" name="year_sales">
                          <span class="input-group-text">.00</span>
                        </div>
                      </div>
                      ...
                      <div class="col-md-12">
                        ...
                        <input type="number" class="form-control" id="industry " name="EBITDA"> 
                    </div>

                    <div class="col-md-12">
                      <label for="all_products_services" class="form-label">List all tangible and intangible assets the business owns</label>
                      <textarea class="form-control" placeholder="" id="all_products_services" name="assets" style="height: 100px;"></textarea>
                    </div>
                    ...
                    <div class="col-md-6">
                      ...
                      <div class="input-group col-md-6">           
                          <span class="input-group-text">AED</span>
                          <input type="text" class="form-control" aria-label="Amount (to the nearest dollar)" name="Phisycal_assets_value">
                          <span class="input-group-text">.00</span>
                        </div>
                      </div>
                    </div>
                ...
                <div class="col-sm-6">
                    ...
                    <input class="form-control" type="file" id="documents" name="document">
                </div>
                <div class="col-sm-6">
                ...
                <div class="col-sm-10 offset-sm-1">
                  <div class="form-check">
                    <input class="form-check-input" name="receiving_quotations" type="checkbox" id="gridCheck1">
                ...
                <div class="col-sm-10 offset-sm-1">
                    <div class="form-check">
                      <input class="form-check-input" name="plan[]" type="checkbox" id="gridCheck1">
                      <label class="form-check-label" for="gridCheck1">
